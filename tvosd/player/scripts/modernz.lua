...
local user_opts = {
    ...
    enhance_button = true,                 -- TV OS: show the Enhance (upscaler) button
...
layouts["default"] = function ()
    ...
    right_side_button("enhance", 450, user_opts.enhance_button)
...
layouts["compact"] = function ()
    ...
    right_side_button("enhance", 300, user_opts.enhance_button)
...
local function osc_init()
    ...
    --enhance (TV OS upscaler: menu on click, A/B vs original on right-click;
    --the menu itself is drawn by scripts/upscaler.lua)
    ne = new_element("enhance", "button")
    ne.content = icons.zoom_in
    ne.tooltipF = locale.enhance
    ne.eventresponder["mbtn_left_up"] = function ()
        mp.command("script-binding upscaler/tvos-upscaler-menu")
    end
    ne.eventresponder["mbtn_right_up"] = function ()
        mp.command("script-binding upscaler/tvos-enhance-toggle")
    end
